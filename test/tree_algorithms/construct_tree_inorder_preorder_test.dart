...
import 'package:algorithms_core/tree_algorithms/construct_tree_inorder_preorder.dart';

void main() {
  group('Construct Tree from Inorder & Preorder', () {
    ...
    test('Empty lists return null', () {
      expect(buildTreeFromInorderPreorder([], []), isNull);
    });
